...
@Entity
@NamedQueries({
//        @NamedQuery(name = "SanPham.getListTenSP", query = "SELECT s.tensp FROM SanPham s"),
        ...
        @NamedQuery(name = "SanPham.getKMTheoTen", query = "SELECT  km FROM KhuyenMai km"),
        ...
        @NamedQuery(name = "SanPham.getChatLieu", query = "SELECT  c FROM ChatLieu c"),
        @NamedQuery(name = "SanPham.getLoaiSP", query = "SELECT  l from LoaiSanPham l"),
